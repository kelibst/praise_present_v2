...
export const BOOK_ABBREVIATIONS: BookAbbreviation[] = [
  // Old Testament
  { book: 'Genesis', abbreviations: ['gen', 'ge', 'gn', 'genesis'], order: 1, testament: 'OT' },
  { book: 'Exodus', abbreviations: ['exo', 'ex', 'exod', 'exodus'], order: 2, testament: 'OT' },
  { book: 'Leviticus', abbreviations: ['lev', 'le', 'lv', 'leviticus'], order: 3, testament: 'OT' },
  { book: 'Numbers', abbreviations: ['num', 'nu', 'nm', 'nb', 'numbers'], order: 4, testament: 'OT' },
  { book: 'Deuteronomy', abbreviations: ['deut', 'de', 'dt', 'deu', 'deuteronomy'], order: 5, testament: 'OT' },
  ...
  { book: 'Psalms', abbreviations: ['ps', 'psa', 'psalm', 'psalms', 'pss'], order: 19, testament: 'OT' },
  ...
  { book: '1 Corinthians', abbreviations: ['1cor', '1 cor', '1co', '1c', 'i cor', '1corinthians', 'icor'], order: 46, testament: 'NT' },
  { book: '2 Corinthians', abbreviations: ['2cor', '2 cor', '2co', '2c', 'ii cor', '2corinthians', 'iicor'], order: 47, testament: 'NT' },
  ...
  { book: '1 John', abbreviations: ['1john', '1 john', '1jn', '1j', 'i john', 'ijohn', '1jo'], order: 62, testament: 'NT' },
  { book: '2 John', abbreviations: ['2john', '2 john', '2jn', '2j', 'ii john', 'iijohn', '2jo'], order: 63, testament: 'NT' },
  { book: '3 John', abbreviations: ['3john', '3 john', '3jn', '3j', 'iii john', 'iiijohn', '3jo'], order: 64, testament: 'NT' },
