...
import { MediaCanvasRenderer } from './media/MediaCanvasRenderer';
            ...
            return (
              <div className="w-full h-full flex items-center justify-center bg-black">
                <video
                  ...
                  style={{ width: '100%', height: '100%' }}
                  onLoadStart={() => {
                    console.log('🎥 Video loading started:', mediaItem.originalName);
                  }}
                  onCanPlay={() => {
                    console.log('✅ Video can play:', mediaItem.originalName);
                  }}
                  onError={(e) => {
                    ...
                    console.error('❌ Video error:', {
                      ...
                      pathLength: mediaItem.path.length,
                      pathPreview: mediaItem.path.substring(0, 100) + '...'
                    });
                  }}
                  onWaiting={() => {
                    console.log('⏳ Video buffering:', mediaItem.originalName);
                  }}
                  onStalled={() => {
                    console.warn('⚠️ Video stalled:', mediaItem.originalName);
                  }}
                  onPlay={() => {
                    console.log('▶️ Video playing:', mediaItem.originalName);
                  }}
                >
