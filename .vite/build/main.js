...
function getProductionDatabasePath() {
  ...
  console.log("[DB INIT]   - app.isPackaged:", electron.app.isPackaged);
  ...
  if (needsInit) {
    const possiblePaths = [
      ...
      // CORRECT path for extraResource
    ...
    try {
      ...
      const windowConfig = {
        ...
        webPreferences: {
          ...
          // Prevent throttling in background
        },
        ...
        // Prevent transparency effects that throttle
      };
